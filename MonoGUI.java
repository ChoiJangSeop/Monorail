...
class PlayMode extends JFrame{	//게임 구동 클래스
	...
	void setIcon(){
		...
		ImageIcon originIcon = new ImageIcon("/Users/최장섭/Desktop/img/t_rail0.png"); //이 경로들 자신에 맞게 수정 
		...
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/t_rail1.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(50, 50, Image.SCALE_SMOOTH );
		t_rail[1] = new ImageIcon(changedImg);
		//TList[1] = new UpDown();
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/t_rail2.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(50, 50, Image.SCALE_SMOOTH );
		t_rail[2] = new ImageIcon(changedImg);
		//TList[2] = new UpRight();
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/t_rail3.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(50, 50, Image.SCALE_SMOOTH );
		t_rail[3] = new ImageIcon(changedImg);
		//TList[3] = new UpLeft(); 
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/t_rail4.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(50, 50, Image.SCALE_SMOOTH );
		t_rail[4] = new ImageIcon(changedImg);
		//TList[4] = new DownLeft(); 
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/t_rail5.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(50, 50, Image.SCALE_SMOOTH );
		t_rail[5] = new ImageIcon(changedImg);
		//TList[5] = new DownRight();
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/rail0.png"); //이 경로들 자신에 맞게 수정 
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(50, 50, Image.SCALE_SMOOTH );
		rail[0] = new ImageIcon(changedImg);
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/rail1.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(50, 50, Image.SCALE_SMOOTH );
		rail[1] = new ImageIcon(changedImg);
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/rail2.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(50, 50, Image.SCALE_SMOOTH );
		rail[2] = new ImageIcon(changedImg);
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/rail3.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(50, 50, Image.SCALE_SMOOTH );
		rail[3] = new ImageIcon(changedImg);
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/rail4.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(50, 50, Image.SCALE_SMOOTH );
		rail[4] = new ImageIcon(changedImg);
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/rail5.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(50, 50, Image.SCALE_SMOOTH );
		rail[5] = new ImageIcon(changedImg);
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/ground.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(50, 50, Image.SCALE_SMOOTH );
		Ground = new ImageIcon(changedImg);
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/rail_input.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(150, 150, Image.SCALE_SMOOTH );
		RailInputImg = new ImageIcon(changedImg);
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/impossible.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(150, 150, Image.SCALE_SMOOTH );
		ImpossibleImg = new ImageIcon(changedImg);
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/complete.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(150, 150, Image.SCALE_SMOOTH );
		CompleteImg = new ImageIcon(changedImg);
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/1P.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(150, 150, Image.SCALE_SMOOTH );
		P1Img = new ImageIcon(changedImg);
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/2P.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(150, 150, Image.SCALE_SMOOTH );
		P2Img = new ImageIcon(changedImg);
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/imp_rail_input.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(150, 150, Image.SCALE_SMOOTH );
		ImpRailInputImg = new ImageIcon(changedImg);
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/imp_complete.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(150, 150, Image.SCALE_SMOOTH );
		ImpCompleteImg = new ImageIcon(changedImg);
		
		originIcon = new ImageIcon("/Users/최장섭/Desktop/img/imp_impossible.png");  
		originImg = originIcon.getImage(); 
		changedImg= originImg.getScaledInstance(150, 150, Image.SCALE_SMOOTH );
